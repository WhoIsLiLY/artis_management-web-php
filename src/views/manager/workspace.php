...
<div class="col-lg-10 pt-12 px-4">
  <div class="flex justify-between items-center mb-6">
    ...
    <button id="add" class="btn btn-success shadow-lg transition duration-300 hover:scale-105">+ Add Artist</button>
  </div>
        ...
        <tbody>
          <?php foreach ($data as $value): ?>
            <tr class="hover:bg-gray-100 transition duration-200">
              ...
              <td class="p-3"> <?= htmlspecialchars($value['nama_artis']); ?> </td>
              ...
              <td class="p-3">
                <button class="btn btn-info shadow-sm transition duration-300 hover:scale-105" id="btn-schedule-<?= $value['id']; ?>">
                  Schedule
                </button>
              </td>
            </tr>
