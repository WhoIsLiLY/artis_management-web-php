<?php
    ...
    if(isset($_GET['id'])){
        $data = $userController->getArtisById($_GET['id']);
    }else{
        header("Location:/src/views/manager/workspace.php");
    }
    if(isset($_POST['submit'])){
        $userController->updateArtisById($_GET['id'], $_POST["data"]);
        
        header("Location: /src/views/manager/contract_update.php?id=".$_GET['id']);
    }
?>
