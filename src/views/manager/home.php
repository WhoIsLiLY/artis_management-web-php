...
<!-- Content -->
<div class="flex row">
  <h1 class="text-4xl font-extrabold text-center mb-5 mt-5 text-white">What should we do, Manager?</h1>

  <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6 w-full max-w-4xl">
    <!-- Card: Manage -->
    ...
    <!-- Card: Contract -->
    <a href="contract.php" class="group">
      <div class="card bg-white/10 backdrop-blur-xl p-6 rounded-2xl shadow-xl border border-white/20 text-center hover:scale-105 hover:shadow-purple-400/50 transition duration-300">
        <img src="./icon_contract.png" class="mx-auto w-20 h-auto group-hover:rotate-6 transition duration-300" alt="Contract Icon">
        <h5 class="mt-4 text-xl font-semibold text-black">Contract</h5>
      </div>
    </a>

    <!-- Card: Contact -->
    <a href="contact.php" class="group">
      <div class="card bg-white/10 backdrop-blur-xl p-6 rounded-2xl shadow-xl border border-white/20 text-center hover:scale-105 hover:shadow-indigo-400/50 transition duration-300">
        <img src="./icon_contact.png" class="mx-auto w-20 h-auto group-hover:rotate-6 transition duration-300" alt="Contact Icon">
        <h5 class="mt-4 text-xl font-semibold text-black">Contact</h5>
      </div>
    </a>

    <!-- Card: Profile -->
    <a href="profile.php?id=<?php echo $middleware->getIdFromToken($_COOKIE['token']); ?>" class="group">
      <div class="card bg-white/10 backdrop-blur-xl p-6 rounded-2xl shadow-xl border border-white/20 text-center hover:scale-105 hover:shadow-green-400/50 transition duration-300">
