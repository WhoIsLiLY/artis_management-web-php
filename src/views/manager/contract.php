...
<div class="col-lg-10 pt-12 px-4">
  <div class="flex justify-between items-center mb-6">
    <h1 class="text-3xl font-bold text-white">Manage Contracts</h1>
  </div>
        ...
        <tbody>
          <?php foreach ($contracts as $value): ?>
            <tr class="hover:bg-gray-100 transition duration-200">
              ...
              <td class="p-3">
                <button class="btn btn-success shadow-sm transition duration-300 hover:scale-105"
                  id="btn-print-<?= $value['id']; ?>" onclick="printPDF(<?= $value['id']; ?>)">
                  Print PDF
                </button>
              </td>
            </tr>
