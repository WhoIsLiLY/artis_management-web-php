...
<div class="col-lg-10 pt-12 px-4">
  <div class="flex justify-between items-center mb-6">
    <h1 class="text-3xl font-bold text-white">Manage Schedules</h1>
    <button id="add" class="btn btn-success shadow-lg transition duration-300 hover:scale-105">+ Add Schedule</button>
  </div>
        ...
        <tbody>
          <?php foreach ($data as $value): ?>
            <tr class="hover:bg-gray-100 transition duration-200">
              ...
              <td class="p-3"> <?= htmlspecialchars($value['nama_acara']); ?> </td>
